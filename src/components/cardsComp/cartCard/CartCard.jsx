                ...
                <div className="side-container">
                    ...
                    <div>
                        ...
                        <div className="action-container">
                            <button className="card-btn action secondary-action font-weight" onClick={() => cartDispatch({ type: "REMOVE_FROM_CART", payload: product.cartProducts })}>Remove From Cart </button>
                        </div>
                    </div>
                    <div className="action-container">
                        <Link to="/wishlist"> <button className="card-btn action primary-action font-weight" to="#" >Move To Wishlist</button></Link>
                    </div>
                </div>
            </div>
        </section >
